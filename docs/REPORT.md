...
Виконав: _Студент_
Спеціальність: _Спеціальність_
Курс, група: _Курс, група_
Керівник: _Керівник_
...
Це означає, що клонувати репозиторій і запустити можна без ключа — система працюватиме у mock-режимі. Це навмисно: захист курсової не повинен залежати від платних API.
